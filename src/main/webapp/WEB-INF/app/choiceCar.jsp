...
<body>
	<form action="car/reg_save" method="post" class="definewidth m20">
		<table class="table table-bordered table-hover definewidth m10">
			...
			<tr>
				...
				<td>
				   出行区域
				   <input type="text" name="requisitionId" value='<s:property value="id"/>'>
				</td>
			...
			<tr>
				...
				<td width="10%" class="tableleft">选择车辆</td>
				<td>
				   <s:select list="ownedlist" name="vehicleId" headerKey="0000" headerValue="--无车辆调度--" listKey="vehicleId" listValue="licenseCode"></s:select>
				</td>
